...
대회 시작이 2023년 11월이었는데, 시상을 2025년 7월에 했다. 대회 기간도 채점 기간도 너무 길어서 다들 지쳐했다. 그렇게 오래 기다려서 트로피를 받았는데 내 이름에 오타가 나서 나는 더욱 서운했지만... 승아가 트로피 사진을 포토샵하며 달래줬다(고마워!). 이래저래 대회 운영에 다소 아쉬움이 남지만 그래도 결과가 좋았으니 괜찮아.

...
subtitle: Archeology, Magic Tricks
...
ctf_date: 2024-09-06
probs:
  - [Magic Tricks, Very Easy, Reversing, Golang]
  - [Archeology, Medium, Reversing, VM]
---
...
`Enter any data...`를 `String Search`하면 `sub_48BA80`이 메인 로직임을 알 수 있다. ~~라고 생각했는데 `ida` 최신 버전을 사용하니까 main.main으로 바로 매칭해준다. `ida` 최신 버전을 사용하자.~~
